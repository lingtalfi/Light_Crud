...
LightBaseCrudRequestHandler::setContainer
================



LightBaseCrudRequestHandler::setContainer — Sets the light service container interface.
...
Source Code
===========
See the source code for method [LightBaseCrudRequestHandler::setContainer](https://github.com/lingtalfi/Light_Crud/blob/master/CrudRequestHandler/LightBaseCrudRequestHandler.php#L46-L49)
...
Previous method: [__construct](https://github.com/lingtalfi/Light_Crud/blob/master/doc/api/Ling/Light_Crud/CrudRequestHandler/LightBaseCrudRequestHandler/__construct.md)<br>Next method: [execute](https://github.com/lingtalfi/Light_Crud/blob/master/doc/api/Ling/Light_Crud/CrudRequestHandler/LightBaseCrudRequestHandler/execute.md)<br>
